...
class PaymentForm extends Component {
    state = {planName:this.props.location.plan.Name
                ,
    cost :this.props.location.plan.Cost}
    render() { 
        return ( 
            <React.Fragment>
                <div className="container" style={{marginRight:"auto"}}>
                    <div className="paymentform">
                        ...
                        <div className="premium" style={{backgroundColor:"#DF3B45",paddingTop:"2.5%",paddingLeft:"1%"}}>
                            <span style={{color:"white",fontWeight:"bold"}}>{this.state.planName} Plan</span>
                        </div>
                        ...
                        and charge the monthly membership free <span style={{color:"red"}}>(currently EGP{this.state.cost})</span> to your payment method until you cancel.
                        </p>
